      ...
      <div className="grid grid-cols-1 gap-3">
        {sources.map((item, idx) => {
          ...
          return (
            <Card
              key={item.id}
              className="border-slate-200/80 bg-white transition-all hover:border-blue-200"
            >
              <CardContent className="p-4">
                ...
                {isExpanded && (
                  <div className="mt-3 pt-3 border-t border-slate-100 text-xs sm:text-sm text-slate-600 leading-relaxed space-y-2">
